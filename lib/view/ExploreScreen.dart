...
class ExploreScreen extends StatelessWidget {
  ExploreScreen({super.key, required this.globalKey});
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(
                            left: index == 0 ? 24 : 10,
                            right: index == categoriesListItems.length - 1
                                ? 24
                                : 10,
                          ),
                          child: Column(
                            children: [
                              AnimatedScale(
                                ...
                                scale: selectedIndex.value == index ? 1.2 : 1,
                                child: Container(
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => ReviewBookScreen()));
                      },
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
